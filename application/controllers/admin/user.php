...
class User extends CI_Controller {
    ...
    public function cek_user(){
        if ( ($this->session->userdata('ses_level') == 'Front Office')){
    ...
    public function detail_data($kode = 0){
        ...
        $data = array(
            ...
            'content' => 'admin/user/user-detail',
        );
        $this->load->view('admin/template/site', $data);
    }
    ...
    public function update_data(){
        ...
        if ($result == 1){
            ...
            redirect('admin/user/edit_data/'.$id_user);
        }
    }
    ...
    public function ganti_password($kode = 0){
        ...
        $data = array(
            'content' => 'admin/template/ganti-password',
    ...
    public function export_excel(){
        ...
        $this->load->view('admin/user/user-laporan-excel',$data);
    }
    ...
    public function export_pdf(){
        ...
        $this->load->view('admin/user/user-laporan-pdf', $data);
        $html = ob_get_clean();
