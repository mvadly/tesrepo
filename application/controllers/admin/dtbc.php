...
class Dtbc extends CI_Controller{
    ...
    public function index(){
        ...
        $data = array(
            ...
            'datatb' => $this->model->GetDataBCT(' order by tgl_masuk desc')->result_array(),
            'content' => 'admin/halaman/datatamubooking/bookingcottage',
    ...
    public function updatejadwalci(){
        ...
        $result = $this->model->Update('data_booking',$data,array('kode_booking' => $kode_booking));
    ...
    public function detail_data($kode = 0){
        ...
        $datatb = $this->model->GetDataBCT("where kode_booking = '$kode' ")->row_array();
        ...
        $data = array(
                    ...
                    'kode_cottage' => $datatb['kode_cottage'],
                    'nama_cottage' => $datatb['nama_cottage'],
                    ...
                    'content' => 'admin/halaman/datatamubooking/detailc',
        );
