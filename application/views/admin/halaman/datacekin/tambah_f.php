        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a href="#widget1" data-toggle="collapse"><span class="fa fa-chevron-down" style="float: right"></span>
                    ...
                    <form action="<?php echo site_url('admin/dcheckinct/simpan_data')?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?php echo site_url('admin/dcheckinct') ?>"> <button type="button" class="btn btn-warning " data-dismiss="modal">Kembali
                            </button>
