        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                Detail Data <span style="font-weight: bolder; float: right;"><?php echo $kode_sewa; ?></span>
                        ...
                        <form action="<?php echo base_url()?>admin/dcheckinct/cekout" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="kode_sewa" value="<?php echo $kode_sewa; ?>"/>
                        <input type="hidden" name="kode_cottage" value="<?php echo $kode_cottage; ?>"/>
                        ...
                        <button onclick="history.back();" class="btn bg-orange">Batal</button></td>
                            ...
                            <tr>
                                ...
                                $this->load->view('admin/halaman/datacekin/cottage');
