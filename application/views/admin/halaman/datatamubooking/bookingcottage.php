<div class="page-header">
    <h2>Booking <small>Cottage</small></h2>
</div>
<div class="row">
        ...
        <tr>
            ...
            <?php }else{?>
             <td width="150" >
                                    ...
                                    <a href="<?php echo base_url('admin/dtbc/detail_data/'.$data['kode_booking']) ;?>" data-toggle="tooltip" data-placement ="top" title="Detail" class="btn btn-success"><span class="fa fa-info" style="font-size: 14pt"></span></a>

                                    <a data-target="#modalbct<?php echo $data['kode_booking']?>" data-toggle="modal" title="Update Jadwal Booking" class="btn bg-blue"><span class="fa fa-hotel" style="font-size: 14pt"></span></a>
