<div class="box box-solid box-danger">
                  <div class="box-header">
                    <h3 class="box-title">Daftar Tamu Check Out Kamar Hotel Hari Ini : <strong><?php echo $tcekoutkh->num_rows();?></strong></h3>
                  </div>
                  <div class="box-body">
                    <div id="widget1" class="panel-body collapse in">
            <fieldset >
            <table id="table4" class="table penelitian table-bordered table-striped " width="100%" >
                <thead>
                    <tr>
                        <th>Kode Sewa</th>
                        <th>Kode Tamu</th>
                ...
                <?php foreach ($tcekoutkh->result_array() as $data) {
