<div class="page-header">
    <h2>Data Check Out <small>Cottage</small></h2>
</div>
<div class="row">
    ...
    <tfoot>     
        <tr>
            ...
            <td class="text-center">
                                    ...
                                    <a href="<?php echo base_url()?>admin/dcheckoutct/cetak_co/<?php echo $data['kode_sewa'];?>" data-toggle="tooltip" data-placement ="top" title="Cetak Faktur Check Out" class="btn bg-green"><span class="fa fa-print" style="font-size: 14pt"></span></a>
